...
export default function EditWeeklyEventScreen() {
    ...
    if (id) {
      ...
      if (foundEvent) {
        setEventData({
          ...
          brewery: foundEvent.brewery,
          breweryLocation: foundEvent.breweryLocation,
          dayOfWeek: foundEvent.dayOfWeek,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Weekly event updated successfully!', [
        { text: 'OK', onPress: () => router.back() }
      ]);
    } catch (error) {
      Alert.alert('Error', 'Failed to update weekly event. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Edit Weekly Event</Text>
        <TouchableOpacity 
